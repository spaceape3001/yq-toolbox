...
if(NOT DEFINED YOUR_QUILL_STANDARD_CMAKE)
    ...
    if(Feature_Lua AND EXISTS ${CMAKE_SOURCE_DIR}/yq-lua)
        find_package(Lua)
        if(Lua_FOUND)
            set(Build_Lua ON)
        else()
    ...
    if(Build_Lua)
        include(${CMAKE_SOURCE_DIR}/yq-lua/configure.cmake)
        add_subdirectory(${CMAKE_SOURCE_DIR}/yq-lua)
    endif()
...
# Diagnostic debugging (google's AI helped)
macro(PrintAllVariables)
...
macro(YQRepo)
    ...
    if(Build_Qt6 AND COMMAND qt_config)
        qt_config()
    endif()
endmacro()
