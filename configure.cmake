...
if(NOT YOUR_QUILL_TOOLBOX)
    ...
    if(NOT DEFINED Build_ASIO)
        set(Build_ASIO          ${Build_ALL})
    endif()
    if(NOT DEFINED Build_CURL)
        set(Build_CURL          ${Build_ALL})
    endif()
    if(NOT DEFINED Build_Doxygen)
        set(Build_Doxygen       ${Build_ALL})
    endif()
    if(NOT DEFINED Build_GLM)
        set(Build_GLM           ${Build_ALL})
    endif()
    if(NOT DEFINED Build_Qt6)
        set(Build_Qt6           ${Build_ALL})
    endif()
    if(NOT DEFINED Build_SDK)
        set(Build_SDK           ${Build_ALL})
    endif()
    if(NOT DEFINED Build_SQL)
        set(Build_SQL           ${Build_ALL})
    endif()
    if(NOT DEFINED Build_Timing)
        set(Build_Timing        ${Build_ALL})
    endif()
    if(NOT DEFINED Build_UnitTests)
        set(Build_UnitTests     ${Build_ALL})
    endif()
    if(NOT DEFINED Build_Vulkan)
        set(Build_Vulkan        ${Build_ALL})
    endif()
    ...
    add_definitions(
        ...
        -Wno-trigraphs                  # I mean... trigraphs were cool and all, now deprecated
        -Wall 
        -fno-strict-aliasing 
        -D_GNU_SOURCE 
        -fdiagnostics-color 
