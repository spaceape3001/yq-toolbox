...
namespace yq {
    ...
    #if defined(YQ__API__MATH__TENSOR_1_1__HPP) && defined(YQ__API__MATH__TENSOR_2_1__HPP)
    template <typename T>
        template <typename U>
    ...
    #ifdef YQ__API__MATH__TENSOR_2_2__HPP
    template <typename T>
        template <typename U>
    ...
    #ifdef YQ__API__MATH__TENSOR_2_1__HPP
    template <typename T>
