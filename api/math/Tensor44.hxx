...
namespace yq {
    ...
    constexpr Tensor44<trait::product_t<T,U>>  Tensor44<T>::operator*(U b) const noexcept
    {
    ...
    template <typename T>
        template <typename U>
    constexpr Tensor41<trait::product_t<T,U>> Tensor44<T>::operator*(const Tensor41<U>& b) const noexcept
    {
    ...
    template <typename T>
        template <typename U>
    constexpr Tensor42<trait::product_t<T,U>> Tensor44<T>::operator*(const Tensor42<U>& b) const noexcept
    {
    ...
    template <typename T>
        template <typename U>
    constexpr Tensor43<trait::product_t<T,U>> Tensor44<T>::operator*(const Tensor43<U>& b) const noexcept
    {
    ...
    template <typename T>
        template <typename U>
    constexpr Tensor44<trait::product_t<T,U>> Tensor44<T>::operator*(const Tensor44<U>& b) const noexcept
    {
        return Tensor44<trait::product_t<T,U>>(
            xx*b.xx + xy*b.yx + xz*b.zx + xw*b.wx,
            xx*b.xy + xy*b.yy + xz*b.zy + xw*b.wy,
    ...
    template <typename T>
        template <typename U>
    Triangle4<trait::product_t<T,U>> Tensor44<T>::operator*(const Triangle4<U>&rhs) const noexcept
    {
    ...
    template <typename T>
        template <typename U>
    constexpr Vector4<trait::product_t<T,U>> Tensor44<T>::operator*(const Vector4<U>&b) const noexcept
    {
    ...
    {
        return transform(bs, [&](const Vector4<U>& b) -> Vector4<trait::product_t<T,U>> {
            return *this * b;
        });
    }
    ...
    template <typename T>
        template <typename U>
    requires trait::is_arithmetic_v<U>
    constexpr Tensor44<trait::quotient_t<T,U>>  Tensor44<T>::operator/(U b) const noexcept
    {
        return Tensor44<trait::quotient_t<T,U>>(
            xx/b, xy/b, xz/b, xw/b,
            yx/b, yy/b, yz/b, yw/b,
            zx/b, zy/b, zz/b, zw/b,
            wx/b, wy/b, wz/b, ww/b
