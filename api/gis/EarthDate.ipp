...
namespace yq {
    ...
    JulianDay               julian_day(EarthDate v)
    {
        if(v.year < 0)
            ++v.year;
    ...
    {
        static const std::span<EarthDate>   s_ret(kLeapSeconds);
        return s_ret;
    }
