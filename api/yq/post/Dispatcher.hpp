    ...
    */
    ...
    protected:
        ...
        /*! \brief Dispatches a post
            ...
            \note flags are ONLY added if this is the original dispatcher
        */
        void            dispatch(PostPtr, Post::flag_initlist_t flags = {});
        
        template <SomePost M>
        const M&        dispatch(Post* msg, ref_t)
        {
            assert(msg);
            dispatch(msg);
            return *msg;
        ...
        template <SomePost M>
        const M&        dispatch(Post* msg, Post::flag_initlist_t flags, ref_t)
        {
            assert(msg);
            dispatch(msg, flags);
            return *msg;
