...
namespace yq::lua {
    ...
    std::error_code         push(lua_State*, meta_k, const Meta*, XFlags flags={});
    std::error_code         push(lua_State*, meta_k, const ObjectMeta*, XFlags flags={});
    std::error_code         push(lua_State*, meta_k, const TypeMeta*, XFlags flags={});
