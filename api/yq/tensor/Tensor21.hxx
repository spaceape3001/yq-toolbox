...
namespace yq {
    ...
    constexpr bool Tensor21<T>::all_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) && 
            pred(yx) 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor21<T>::all_kest(const Tensor21& b, Pred pred) const noexcept
    {
        return 
            pred(xx, b.xx) && 
            pred(yx, b.yx) 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor21<T>::all_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) && 
            pred(yx, b) 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor21<T>::any_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) || 
            pred(yx) 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor21<T>::any_kest(const Tensor21& b, Pred pred) const noexcept
    {
        return 
            pred(xx, b.xx) || 
            pred(yx, b.yx) 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor21<T>::any_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) || 
            pred(yx, b)
