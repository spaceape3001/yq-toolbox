...
namespace yq {
    ...
    */
    ...
    struct Tensor31 {
        ...
        consteval Tensor31(zero_k) : Tensor31(ALL, zero_v<T>) {} 
        ...
        //  AllComponents Adapters
            ...
            */
            template <typename Pred>
            constexpr bool all_kest(const Tensor31& b, Pred pred) const noexcept;
        ...
        //  AnyComponents Adapters
            ...
            */
            template <typename Pred>
            constexpr bool any_kest(const Tensor31& b, Pred pred) const noexcept;
