...
namespace yq {
    ...
    constexpr bool Tensor32<T>::all_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) && pred(xy) && 
            pred(yx) && pred(yy) && 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor32<T>::all_kest(const Tensor32& b, Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor32<T>::all_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) && pred(xy, b) && 
            pred(yx, b) && pred(yy, b) && 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor32<T>::any_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) || pred(xy) || 
            pred(yx) || pred(yy) || 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor32<T>::any_kest(const Tensor32& b, Pred pred) const noexcept
    {
        return 
            pred(xx, b.xx) || pred(xy, b.xy) || 
            pred(yx, b.yx) || pred(yy, b.yy) || 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor32<T>::any_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) || pred(xy, b) || 
            pred(yx, b) || pred(yy, b) || 
