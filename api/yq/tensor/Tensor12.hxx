...
namespace yq {
    ...
    constexpr bool Tensor12<T>::all_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) && pred(xy)
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor12<T>::all_kest(const Tensor12& b, Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor12<T>::all_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) && pred(xy, b)
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor12<T>::any_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) || pred(xy)
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor12<T>::any_kest(const Tensor12& b, Pred pred) const noexcept
    {
        return 
            pred(xx, b.xx) || pred(xy, b.xy) 
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor12<T>::any_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) || pred(xy, b) 
        ;
