...
namespace yq {
    ...
    constexpr bool Tensor14<T>::all_kest(Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor14<T>::all_kest(const Tensor14& b, Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor14<T>::all_kest(T b, Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor14<T>::any_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) || pred(xy) || pred(xz) || pred(xw)
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor14<T>::any_kest(const Tensor14& b, Pred pred) const noexcept
    {
        return 
            pred(xx, b.xx) || pred(xy, b.xy) || pred(xz, b.xz) || pred(xw, b.xw)
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor14<T>::any_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) || pred(xy, b) || pred(xz, b) || pred(xw, b) 
        ;
