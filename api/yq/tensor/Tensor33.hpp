...
namespace yq {
    ...
    */
    ...
    struct Tensor33 {
        ...
        consteval Tensor33(zero_k) : Tensor33(ALL, zero_v<T>) {}
        ...
        template <typename U>
        Tetrahedron3<product_t<T,U>> operator*(const Tetrahedron3<U>&) const noexcept;
        ...
        */
        ...
        //  AllComponents Adapters
            ...
            */
            template <typename Pred>
            constexpr bool all_kest(const Tensor33& b, Pred pred) const noexcept;
