...
namespace yq {
    ...
    constexpr bool Tensor44<T>::all_kest(Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor44<T>::all_kest(const Tensor44& b, Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor44<T>::all_kest(T b, Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor44<T>::any_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) || pred(xy) || pred(xz) || pred(xw) ||
            pred(yx) || pred(yy) || pred(yz) || pred(yw) ||
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor44<T>::any_kest(const Tensor44& b, Pred pred) const noexcept
    {
        return 
            pred(xx, b.xx) || pred(xy, b.xy) || pred(xz, b.xz) || pred(xw, b.xw) ||
            pred(yx, b.yx) || pred(yy, b.yy) || pred(yz, b.yz) || pred(yw, b.yw) ||
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor44<T>::any_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) || pred(xy, b) || pred(xz, b) || pred(xw, b) ||
            pred(yx, b) || pred(yy, b) || pred(yz, b) || pred(yw, b) ||
