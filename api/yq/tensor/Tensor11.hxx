...
namespace yq {
    ...
    constexpr bool Tensor11<T>::all_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) 
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor11<T>::all_kest(const Tensor11& b, Pred pred) const noexcept
    {
        return 
            pred(xx, b.xx) 
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor11<T>::all_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) 
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor11<T>::any_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) 
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor11<T>::any_kest(const Tensor11& b, Pred pred) const noexcept
    {
        return 
            pred(xx, b.xx) 
        ;
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor11<T>::any_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b)
        ;
