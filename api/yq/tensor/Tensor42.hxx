...
namespace yq {
    ...
    constexpr bool Tensor42<T>::all_kest(Pred pred) const noexcept
    {
        return 
            pred(xx) && pred(xy) && 
            pred(yx) && pred(yy) && 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor42<T>::all_kest(const Tensor42& b, Pred pred) const noexcept
    {
        return 
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Tensor42<T>::all_kest(T b, Pred pred) const noexcept
    {
        return 
            pred(xx, b) && pred(xy, b) && 
            pred(yx, b) && pred(yy, b) && 
