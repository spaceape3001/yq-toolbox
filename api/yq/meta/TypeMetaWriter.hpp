...
#include <yq/trait/can_multiply.hpp>
#include <yq/trait/can_negate.hpp>
#include <yq/trait/can_subtract.hpp>
#include <yq/trait/can_two_add.hpp>
#include <yq/trait/can_two_divide.hpp>
