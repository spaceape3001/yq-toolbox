    ...
    */
    ...
    //  Flags/Flags
		...
		*/
        ...
        //! Sets the right flags onto the LHS flags, returns reference
        Flags&   operator|=(Flags f) noexcept
        {
            m_value |= f.m_value;
            return *this;
    ...
    //  Flags/Enum
		...
		//! Add/Union flag to enumeration, returns the result
        constexpr Flags        operator+(E e) const noexcept
        {
            return Flags(m_value | mask(e) );
        }
    
		//! Subtract/remove flag to enumeration, returns result
        constexpr Flags        operator-(E e) const noexcept
        {
            return Flags(m_value & ~mask(e) );
        }
		...
		//! Adds/Unions in specific enum into the LHS flags, returns reference
