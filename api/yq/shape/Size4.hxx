...
namespace yq {
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Size4<T>::any_kest(Pred pred) const noexcept
    {
        return pred(x) || pred(y) || pred(z) || pred(w);
    }
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Size4<T>::any_kest(const Size4& b, Pred pred) const noexcept
    {
        return pred(x, b.x) || pred(y, b.y) || pred(z, b.z) || pred(w, b.w);
    }
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Size4<T>::any_kest(T b, Pred pred) const noexcept
    {
        return pred(x, b) || pred(y, b) || pred(z, b) || pred(w, b);
    }
