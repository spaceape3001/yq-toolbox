...
namespace yq {
    ...
    */
    ...
    struct Size3 {
        ...
        consteval Size3(one_k) : Size3(ALL, one_v<T>) {}
        
        template <typename=void> requires has_nan_v<T>
        consteval Size3(nan_k) : Size3(ALL, nan_v<T>) {}
...
YQ_TYPE_DECLARE(yq::Size3M)
YQ_TYPE_DECLARE(yq::Size3CM)
