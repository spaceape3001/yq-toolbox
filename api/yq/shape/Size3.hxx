...
namespace yq {
    ...
    template <typename T>
    constexpr Size3<T>   Size3<T>::emax(T b) const noexcept
    {
        return Size3(max(x, b), max(y, b), max(z, b));
    }
    ...
    template <typename T>
    constexpr Size3<T>   Size3<T>::emin(T b) const noexcept
    {
        return Size3(min(x, b), min(y, b), min(z, b));
    }
