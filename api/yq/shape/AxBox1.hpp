...
namespace yq {
    ...
    */
    ...
    struct AxBox1 {
        ...
        */
        ...
        consteval AxBox1(identity_k) : lo(ZERO), hi(ONE) {}
        ...
        */
        ...
        //! Moves this box by the given displacemet
        ...
        //! Returns a box scaled by the given amount
        template <typename U>
    ...
    */
    ...
    //! Scales the right box by the left amount, returns it
