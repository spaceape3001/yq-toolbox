...
{
    {
        ...
        w.format<math_io::format<AxBox4D>>();
        w.parse<math_io::parse<AxBox4D>>();
    }

    {
        ...
        w.format<math_io::format<AxBox4F>>();
        w.parse<math_io::parse<AxBox4F>>();
    }
    
    {
        ...
        w.format<math_io::format<AxBox4I>>();
        w.parse<math_io::parse<AxBox4I>>();
    }
    
    {
        ...
        w.format<math_io::format<AxBox4U>>();
        w.parse<math_io::parse<AxBox4U>>();
    }
}
