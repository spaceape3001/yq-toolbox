...
namespace yq {
    ...
    namespace unit {
        ...
        using CentimeterF               = SCALED<float,dim::Length,(double) def::centi>;
        ...
        using InchF                     = SCALED<float,dim::Length,(double) def::inch>;
        ...
        using KilometerF                = SCALED<float,dim::Length,(double) def::kilo>;
        ...
        using MileF                     = SCALED<float,dim::Length,(double) def::mile>;
        ...
        using MinuteF                   = SCALED<float,dim::Time, (double) def::minute>;   
        ...
        using Foot1D                    = Vector1<Foot>;
        using Foot2D                    = Vector2<Foot>;
        using Foot3D                    = Vector3<Foot>;
        using Foot3F                    = Vector3<FootF>;
        using Foot4D                    = Vector4<Foot>;
        using Inch1D                    = Vector1<Inch>;
        using Inch2D                    = Vector2<Inch>;
        using Inch3D                    = Vector3<Inch>;
        using Inch3F                    = Vector3<InchF>;
        using Inch4D                    = Vector4<Inch>;
        using Kilometer1D               = Vector1<Kilometer>;
        using Kilometer2D               = Vector2<Kilometer>;
        using Kilometer3D               = Vector3<Kilometer>;
        using Kilometer4D               = Vector4<Kilometer>;
    ...
    using unit::Inch4D;
    using unit::Kilogram;
    using unit::Kilometer;
    using unit::Kilometer1D;
    using unit::Kilometer2D;
    using unit::Kilometer3D;
    using unit::Kilometer4D;
    using unit::Meter;
    using unit::Meter1D;
    using unit::Meter2D;
    using unit::Meter3D;
    ...
    using unit::Millimeter;
    using unit::Millimeter1D;
