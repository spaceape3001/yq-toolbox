...
{
    {
        ...
        w.format<math_io::format<Bivector4D>>();
        w.parse<math_io::parse<Bivector4D>>();
        w.print<math_io::print<Bivector4D>>();
    }
...

    {
        ...
        w.format<math_io::format<Bivector4F>>();
        w.parse<math_io::parse<Bivector4F>>();
        w.print<math_io::print<Bivector4F>>();
    }
