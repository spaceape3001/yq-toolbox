...
namespace yq {
    ...
    */
    ...
    struct Multivector1 {
        ...
        constexpr Multivector1(all_k, T v) noexcept : a(v), x(v) {}
...
//  --------------------------------------------------------
    ...
    //! Subtracts a multivector from a scalar
    template <typename T>
    constexpr Multivector1<T> operator-(T a, const Multivector1<T>& b) noexcept;

    //! Multiplies left scalar with right multivector, returns the result
