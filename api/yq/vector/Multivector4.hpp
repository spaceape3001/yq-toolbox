...
namespace yq {
    ...
    */
    ...
    struct Multivector4 {
        ...
        //! Subtracts bivector from this multivector, returns reference
        Multivector4&           operator-=(const Bivector4<T>& b) noexcept;
        ...
        //! Subtracts trivector from this multivector, returns reference
        Multivector4&           operator-=(const Trivector4<T>& b) noexcept;
...
//  --------------------------------------------------------
    ...
    //! Multiply scalar with multivector, return result
