...
namespace yq {
    ...
    template <typename T>
    constexpr square_t<T> Vector2<T>::operator^(two_k) const noexcept
    {
        return x*x + y*y;
    }    
    ...
    constexpr bool Vector2<T>::all_kest(Pred pred) const noexcept
    {
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Vector2<T>::all_kest(const Vector2& b, Pred pred) const noexcept
    {
    ...
    template <typename T>
        template <typename Pred>
    constexpr bool Vector2<T>::all_kest(T b, Pred pred) const noexcept
    {
