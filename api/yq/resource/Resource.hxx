...
namespace yq {
    ...
    {
        if constexpr (std::is_invocable_r_v<A*, Pred, const ByteArray&, const ResourceLoadAPI&>){
        ...
        } else if constexpr (std::is_invocable_r_v<A*, Pred, const json&, const ResourceLoadAPI&>){
        ...
        } else if constexpr (std::is_invocable_r_v<A*, Pred, const KVDocument&, const ResourceLoadAPI&>){
        ...
        } else if constexpr (std::is_invocable_r_v<A*, Pred, const KVTree&, const ResourceLoadAPI&>){
        ...
        } else if constexpr (std::is_invocable_r_v<A*, Pred, const std::filesystem::path&, const ResourceLoadAPI&>){
        ...
        } else if constexpr (std::is_invocable_r_v<A*, Pred, std::istream&, const ResourceLoadAPI&>){
        ...
        } else if constexpr (std::is_invocable_r_v<A*, Pred, const std::string&, const ResourceLoadAPI&>){
        ...
        } else if constexpr (std::is_invocable_r_v<A*, Pred, const UrlView&, const ResourceLoadAPI&>){
        ...
        } else if constexpr (std::is_invocable_r_v<A*, Pred, const XmlDocument&, const ResourceLoadAPI&>){
