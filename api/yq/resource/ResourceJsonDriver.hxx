...
namespace yq {
    ...
    public:
        ...
        ResourceInfo* info(const json& file, const ResourceInfoAPI& api) const override
        {
    ...
    public:
        ...
        ResourceInfo* info(const json& file, const ResourceInfoAPI&) const override
        {
    ...
    public:
        ...
        Resource* load(const json& file, const ResourceLoadAPI& api) const override
        {
            return m_function(file, api);
        }
    ...
    public:
        ...
        Resource* info(const json& file, const ResourceLoadAPI&) const override
        {
            return m_function(file);
        }
